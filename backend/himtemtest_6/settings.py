"""
Django settings for himtemtest_6 project.
...
ROOT_URLCONF = 'himtemtest_6.urls'
...
WSGI_APPLICATION = 'himtemtest_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "himtemtest_6 API",
    "DESCRIPTION": "API documentation for himtemtest_6 App",
    "VERSION": "v1",
}
